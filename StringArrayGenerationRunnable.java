...
public class StringArrayGenerationRunnable implements Runnable {
	...
	// this arrayList will store operations of searching waiting time in
	// nanoseconds
	private ArrayList<Long> mSearchWaitTime;
	// this arrayList will store operations of replacing and searching waiting
	// time in nanoseconds
...
//				}
					...
					System.out.println("Average replace waiting Time: : " + Math.round(avergeReplaceTime) + 
	...
	public int getOperationNumber() {
		...
		int operationNum = rand.nextInt(2501);// generate int from 0 to 2500
												// inclusive
		return operationNum;
	}
